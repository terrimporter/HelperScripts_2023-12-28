#!/usr/bin/perl
# Edit to grab bacterial rbcL only (outgroup taxa)
#Aug. 25, 2016 edit search term to look for rbcL NOT CO1 for diatoms!
...
#USAGE perl grab_many_gb_catch_errors.plx
...
#my $out;
my $taxonlist;
my $outfilename = "out.gb";
my $term;
#my @in;

$term = "rbcL[GENE] AND Bacteria[ORGN]";
...
open (OUT, ">", $outfilename) || die "Can't open file: $!\n";
