...
while ($files[$i]) {
	...
	$newfilename = $site."_".$locus."_".$subsite.$block.".fasta";
...
$output = system('usearch6.0.307_i86linux32 -sortbysize cluster.nonch.fasta -minsize 2 -output cluster_97otus_minsize2.fasta');
