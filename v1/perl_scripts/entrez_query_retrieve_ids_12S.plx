#!/usr/bin/perl
# Teresita M. Porter, July 26/21
# Script to submit an Entrez query to nucleotide database, retrieve ids for later retrieval
# narrow search by SLEN and PDAT (publication date) to reduce records returned to try to avoid download problems
...
# array
 my @years = ("1982:1998","1999","2000","2001","2002","2003","2004","2005","2006","2007","2008","2009","2010","2011","2012","2013","2014","2015","2016","2017","2018","2019","2020","2021","2022");
...
sub submit_entrez_query{
	...
	$term = '12S AND Vertebrata[ORGN] AND 500:2000[SLEN] AND ('.$query.'[PDAT])';
