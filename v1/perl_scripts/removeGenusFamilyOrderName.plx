#!/usr/bin/perl
#Modified to remove genus, family, and order refs so taht trained rank eq class
...
open (OUT,">>","mytrainseq_nogenus_nofamily_noorder.fasta") || die "Error writing mytrainseq_nogenus_nofamily_noorder.fasta: $!\n";
