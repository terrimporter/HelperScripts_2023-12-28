#!/usr/bin/perl
#April 26, 2018 edit to just grab a list of GB Accessions from 2003-2017 for records with BARCODE keyword, remove taxonlist requirement
...
my $hist;
my $retry;
my $out="GB_BARCODE.txt";
my $filename;
my $term;
my @in;

$term = "(\"CO1\"[GENE] OR \"COI\"[GENE] OR \"COX1\"[GENE] OR \"COXI\"[GENE]) AND \"Eukaryota\"[ORGN] AND \"2003\"[PDAT]:\"2017\"[PDAT] AND \"BARCODE\"[KYWD])";
