#!/usr/bin/perl
#Sept.18/18 edit to handle assignments to genus rank only (for 16S)
#Feb. 27/18 add column headers, csv output instead of tab-delimited
...
print OUT "GlobalESV,SampleName,ESVsize,Strand,Domain,DomainRank,dBP,Phylum,PhylumRank,pBP,Class,ClassRank,cBP,Order,OrderRank,oBP,Family,FamilyRank,fBP,Genus,GenusRank,gBP\n";
