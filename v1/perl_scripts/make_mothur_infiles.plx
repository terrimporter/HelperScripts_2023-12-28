...
sub uclust {
	...
	@output2 = qx(uclust --input sorted.fna --uc results.uc --id 0.97 --optimal --rev --usersort);
	@output3 = qx(uclust --uc2fasta results.uc --input sorted.fna --output results.fasta);
...
open (IN,"<","results.fasta") || die "Error cannot read results.fasta file: $!\n";
...
$num_otus = qx(grep "*" results.fasta | wc -l);
chomp $num_otus;
print "num_otus: $num_otus\n";#test

$outfile1 = "results.fasta.list";
