#!/usr/bin/perl
#Modified to remove genus, family, order, and class refs so trained rank eq phylum
#Modified to remove genus, family, and order refs so trained rank eq class
...
open (OUT,">>","mytaxa_nogenus_nofamily_noorder_noclass.txt") || die "Error writing outfile.txt: $!\n";
