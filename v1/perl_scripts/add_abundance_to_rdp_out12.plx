#!/path/to/miniconda3/envs/MetaWorks_v1/bin/perl
# Teresita M. Porter, June 22, 2020
# Script to add read abundance from ESV.table to rdp.out
# Prints to STDOUT so redirect to a file in snakemake
# USAGE perl add_abundance_to_rdp_out12.plx ESV.table rdp.csv.tmp > rdp.csv.tmp2
...
print STDOUT "GlobalESV,SampleName,ESVsize,ORFseq,Strand,Root,RootRank,rBP,SuperKingdom,SuperKingdomRank,skBP,Kingdom,KingdomRank,kBP,Phylum,PhylumRank,pBP,Class,ClassRank,cBP,Order,OrderRank,oBP,Family,FamilyRank,fBP,Genus,GenusRank,gBP,Species,SpeciesRank,sBP\n";
