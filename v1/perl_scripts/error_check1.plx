#!/usr/bin/perl
#Oct.18, 2011 edited to create reference gi\trank\n file for the 0% error reference
#new usage perl error_check1.plx features.txt.parsed gb.query gi.query megan_hit_lineage.txt.mapped
...
open (PHYLUM,">>","phylum.ref") || die "Error cannot write to phylum.ref: $!\n";
...
open (ORDER,">>","order.ref") || die "Error cannot write to order.ref: $!\n";
...
open (FAMILY,">>","family.ref") || die "Error cannot write to family.ref: $!\n";
...
open (GENUS,">>","genus.ref") || die "Error cannot write to genus.ref: $!\n";
