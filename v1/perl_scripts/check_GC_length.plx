...
open (GC, ">>", "ITS1.gc") || die "Error cannot open ITS1 gc outfile: $!\n";
...
open (GC, ">>", "ITS2.gc") || die "Error cannot open ITS2 gc outfile: $!\n";
...
$result = qx(cat ITS1.gc ITS2.gc > ITS1ITS2.gc); #use this one for R?
