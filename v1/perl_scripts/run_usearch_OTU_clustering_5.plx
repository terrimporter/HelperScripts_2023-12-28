#!/usr/bin/perl
#May 15, 2013 edited to use the OTU clustering pipeline without the denoising step
...
$result = system('usearch6.0.307_i86linux32 -sortbysize ITS1_derep.fa -output ITS1_derep.fa.sorted');

$result = system('usearch6.0.307_i86linux32 -uchime_denovo ITS1_derep.fa.sorted -nonchimeras ITS1_nonch_denovo.fa -chimeras ITS1_ch_denovo.fa');

$result = system('usearch6.0.307_i86linux32 -uchime_ref ITS1_derep.fa.sorted -db ITS1_nonch_denovo.fa -strand plus -nonchimeras ITS1_nonch_ref.fa -chimeras ITS1_ch_ref.fa');
...
$result = system('usearch6.0.307_i86linux32 -sortbysize ITS2_derep.fa -output ITS2_derep.fa.sorted');

$result = system('usearch6.0.307_i86linux32 -uchime_denovo ITS2_derep.fa.sorted -nonchimeras ITS2_nonch_denovo.fa -chimeras ITS2_ch_denovo.fa');

$result = system('usearch6.0.307_i86linux32 -uchime_ref ITS2_derep.fa.sorted -db ITS2_nonch_denovo.fa -strand plus -nonchimeras ITS2_nonch_ref.fa -chimeras ITS2_ch_ref.fa');
