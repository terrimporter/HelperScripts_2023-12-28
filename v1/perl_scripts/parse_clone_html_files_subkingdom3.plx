...
open (OUT,">>","clone_summary_subkingdom.txt") || die ("Error cannot write to outfile:$!\n");
...
open (IN,"<","clone_summary_subkingdom.txt") || die ("Error cannot read from clone summary txt: $!\n");
@in = <IN>;
close IN;

open (OUT2,">>","clone_summary_best_subkingdom.txt") || die ("Error cannot write to clone summary best txt: $!\n");
