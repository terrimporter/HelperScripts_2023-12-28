#!/usr/bin/perl
#Oct.18,2010 modified to work with .b6 output from ublast that has been filtered to retain only best top hits
...
#usage $perl hit_read_freq.plx filtered.b6 clusters.table
