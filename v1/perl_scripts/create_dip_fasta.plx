#!/usr/bin/perl
#June 17, 2013 edited to process Diptera
...
#usage perl create_dip_fasta.plx iBOLD_dip.txt
...
open (OUT, ">>", "dip.fasta") || die "Error cannot open outfile: $!\n";
...
open (OUT2, ">>", "dip_country.txt") || die "Error cannot open 2nd outfile: $!\n";
