...
#usage perl part6_postextractor.plx ITS1.fasta outdata.csv seqtrim.qual.newlineremoved
...
open (ITS1, "<", $ARGV[0]) || die "Error cannot open ITS1.fasta: $!\n";
@ITS1 = <ITS1>;
close ITS1;
...
$outfile = "ITS1.fasta.stats";
print "running get_stats\n";
get_stats(\@ITS1,$outfile);
