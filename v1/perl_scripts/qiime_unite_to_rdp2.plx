...
# update qiime_unite_to_rdp.plx to append SH's to species name and remove acc
# update to create mytaxon.txt from mytrainseq.fasta (not original fasta)
# add outgroups
# USAGE perl qiime_unite_to_rdp2.plx file.fasta file.taxonomy
...
%problems = (
#		'f__Nectriaceae_g__unidentified','1'
#		'g__Cryptococcus','1',
#		'g__Cenangiopsis','1',
#		'g__Aleurina','1',
#		'g__Cylindrium','1',
...
#				$previoustaxon = $taxon; # only needed if next taxon is unidentified
				...
				#test
#				if ($taxon eq 'f__Nectriaceae_g__unidentified') {
#					print "found f__Nectriaceae_g__unidentified when searching for __unidentified\n";
#				}
...
#			}
			...
			if (exists $taxon{$taxon} ) {
				...
				#test
#		if ($taxon eq 'f__Nectriaceae_g__unidentified') {
#					print "found f__Nectriaceae_g__unidentified, was previously added to hash\n";
#				}
				...
				#test
#				if ($taxon eq 'f__Nectriaceae_g__unidentified') {
#					print "found f__Nectriaceae_g__unidentified, was added to hash\n";
#				}
