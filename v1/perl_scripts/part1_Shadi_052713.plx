...
my $pwd = '/1/scratch/terri/Shadi_052713/Biomonitoring-share/';  ### hard coded, update this as needed
my $grep_term;
my $file_ext;
my $search_term;
my $file_ext2;
...
#			print "file:$file\n";
			...
			if ($file !~ /^\./ && $file =~ /$search_term/) {
				...
				$output = qx(cutadapt -b $primer -e 0.1 -m 100 -M 400 -q 20 -O 15 -n 2 $infile > $outfile);
				# -b infile
				# -o outfile
