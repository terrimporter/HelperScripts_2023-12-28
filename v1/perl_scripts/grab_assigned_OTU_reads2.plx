...
#Aug.26, 2011 edited to parse seed.fasta file from newer Usearch output, no longer uses * to indicate the seed sequences in the fasta file because they are all seed sequences in the fasta file!
