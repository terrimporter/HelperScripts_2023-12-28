#!/usr/bin/perl
# April 2, 2019 by Teresita M. Porter
# Script to grab longest ORF (open reading frame) from ORFfinder nucleotide output (outfmt 1)
# cutoff = minimum number of base pairs in ORFs to keep
# USAGE perl get_longest_orf.plx orf_nt.fasta cutoff
...
my $seq;
my $longest;
my $minimum = $ARGV[1]; #mode length after primer trimming BR5 = 310bpp, F230R = 229bp
