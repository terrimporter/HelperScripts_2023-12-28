#!/usr/bin/perl
#Nov. 25, 2016 edit to work with Katie's files
#Oct. 24, 2016 edited to parse blackbrook samples, original was for red river samples
...
while ($files[$i]) {
	...
	if ($file =~/^\w/) {
		print "file: $file\n";#test
		$sample = substr($file,0,6); #i.e. RR01
