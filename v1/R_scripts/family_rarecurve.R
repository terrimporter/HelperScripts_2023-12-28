...
rarecurve_family<-function (x, step, sample,main="Greer01_Tube01 DK 16S",xlab = "Reads", ylab = "Families",label = TRUE, col, lty, ...){
	x <- as.matrix(x)
...
rarecurveout<-rarecurve_family(A_DT, step=100, col="blue4", cex=0.6)
readmin
dev.off()
