...
plot(g.2, main="Goodall similarity metric", xlab="NMDS1", ylab="NMDS2", pch=c(15,15,15,15,17,17,17,17), col=c("steelblue","firebrick","olivedrab4", "mediumpurple4","steelblue","firebrick","olivedrab4", "mediumpurple4" ))
#dev.off()
...
plot(G.2, main="Chi squared", xlab="NMDS1", ylab="NMDS2", pch=c(15,15,15,15,17,17,17,17), col=c("steelblue","firebrick","olivedrab4", "mediumpurple4","steelblue","firebrick","olivedrab4", "mediumpurple4" ))
