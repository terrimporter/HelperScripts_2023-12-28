...
dis <-vegdist(rbcLF, method="bray", binary=FALSE)
...
plot(clus3, hang=-1, ylab="Sorensen dissimilarity", main="9 pooled cores per sample")

#vegemite(rbcLF, clus3)
...
#mod$maxcls
#mod$pval
summary(mod, type="short", p=0.05, too.many=100000)
