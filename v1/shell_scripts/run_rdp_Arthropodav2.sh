...
for f in RedriverBEfastas/*.fasta
do

echo $f

#Run cutadapt RDP classifier using COI Arthropoda v2 training set
java -Xmx8g -jar dist/classifier.jar classify -t /home/terri/ArthropodaClassifier/v2/mydata/mydata_trained/rRNAClassifier.properties -o ${f}.out $f &
