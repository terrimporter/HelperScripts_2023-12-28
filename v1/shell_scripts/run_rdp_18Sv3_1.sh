...
java -Xmx8g -jar /home/terri/rdp_classifier_2.12/dist/classifier.jar classify -t /home/terri/18S_Eukaryota/v3.1/mydata/mydata_trained/rRNAClassifier.properties -o ${f}.out $f &
