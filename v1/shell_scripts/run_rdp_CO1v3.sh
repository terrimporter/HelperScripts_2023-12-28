...
java -Xmx8g -jar /home/terri/rdp_classifier_2.12/dist/classifier.jar classify -t /home/terri/CO1Classifier/v3_species/mydata/mydata_trained/rRNAClassifier.properties -o ${f}.out $f &
