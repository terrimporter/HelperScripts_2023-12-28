...
#USAGE zsh run_rdp_CO1Lepidoptera_v2.sh
...
java -Xmx8g -jar /home/terri/rdp_classifier_2.12/dist/classifier.jar classify -t /home/terri/CO1Lepidoptera/v2/mydata/mydata_trained/rRNAClassifier.properties -o ${f}.out $f &
