...
print("Parsing the test.fasta file...")
...
# initialize mapping file
print("Parsing the train.fasta file...")
...
print("Parsing the classifier results file...")
...
print("Checking species assignments...")
#presence = []
correct = []
support = []
...
#presence = []
print("Checking genus assignments...")
correct = []
support = []
for index, row in df.iterrows():
	# taxonomic assignment from test_data.out
...
#presence = []
print("Checking family assignments...")
correct = []
support = []
for index, row in df.iterrows():
	# taxonomic assignment from test_data.out
...
#presence = []
print("Checking phylum assignments...")
correct = []
support = []
for index, row in df.iterrows():
	# taxonomic assignment from test_data.out
...
#presence = []
print("Checking kingdom assignments...")
correct = []
support = []
for index, row in df.iterrows():
	# taxonomic assignment from test_data.out
...
#presence = []
print("Checking superkingdom assignments...")
correct = []
support = []
for index, row in df.iterrows():
	# taxonomic assignment from test_data.out
...
print("Binning support values results...")
...
# now try to prevent wrapping by setting width to 2x what I need, ugh
