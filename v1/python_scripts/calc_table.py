...
species_df = pd.DataFrame(list(zip(presence, correct, support)),
		columns=['presence','correct','support'])
...
genus_df = pd.DataFrame(list(zip(presence, correct, support)),
		columns=['presence','correct','support'])
genus_df['rank'] = "Genus"
...
family_df = pd.DataFrame(list(zip(presence, correct, support)),
		columns=['presence','correct','support'])
...
order_df = pd.DataFrame(list(zip(presence, correct, support)),
		columns=['presence','correct','support'])
order_df['rank'] = "Order"
...
class_df = pd.DataFrame(list(zip(presence, correct, support)),
		columns=['presence','correct','support'])
class_df['rank'] = "Class"
...
phylum_df = pd.DataFrame(list(zip(presence, correct, support)),
		columns=['presence','correct','support'])
...
kingdom_df = pd.DataFrame(list(zip(presence, correct, support)),
		columns=['presence','correct','support'])
...
superkingdom_df = pd.DataFrame(list(zip(presence, correct, support)),
		columns=['presence','correct','support'])
